    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-border shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
         <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="flex items-center gap-2 hover:scale-105 transition-transform cursor-pointer">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className={`relative z-10 container mx-auto px-4 text-center text-white transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="mb-6 inline-block">
            <div className="flex items-center gap-2 bg-secondary/20 backdrop-blur-sm px-4 py-2 rounded-full border border-secondary/40">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+385989384184">
              <Button size="lg" className="bg-gradient-to-r from-secondary to-orange-500 hover:from-orange-500 hover:to-orange-600 text-white text-lg px-8 shadow-lg hover:shadow-xl transition-all">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="p-8 hover:shadow-2xl transition-all duration-300 border-border bg-gradient-to-br from-white to-gray-50 hover:border-secondary group overflow-hidden relative"
                >
                  <div className={`absolute inset-0 bg-gradient-to-br ${service.color} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}></div>
                  
                  <div className="relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-secondary/20 to-orange-200 rounded-xl flex items-center justify-center mb-6 group-hover:shadow-lg transition-all">
      ...
      <section className="py-24 bg-gradient-to-br from-primary/5 to-secondary/5">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-xl hover:bg-white/50 transition-colors">
      ...
      <footer className="bg-gradient-to-r from-primary to-blue-700 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-white/20 pt-8 text-center text-white/60">
            <p>&copy; 2026 Elektro Hegediš. Sva prava zadržana. Izrada web stranice: Manus</p>
          </div>
        </div>
      </footer>
    </div>
